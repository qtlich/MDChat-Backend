...
public class PostController {
    ...
    public ResponseEntity<List<PostResponse>> getPostsByChannel(@PathVariable Long channelId) {
        return status(HttpStatus.OK).body(postService.getPostsByChannel(channelId));
    }
